...
- `.context/specs/icon.md` — sibling icon primitive (different sourcing: theme `icon-*.svg` files vs Shopify's `payment_type_svg_tag`); shared decorative-by-default pattern
