...
- `.context/specs/utility--asset-loader.md` — primary consumer; routes the `css: 'inline' + css_content` path through this minifier
- `.context/specs/utility--core-assets.md` — orchestrates two inline blocks both passing through this minifier
- `.context/specs/utility--dynamic-style.md` — per-instance CSS scoping; its content flows through the asset-loader and minifier
