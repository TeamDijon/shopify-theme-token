...
- `blocks/group.liquid` v1.5.0 (block schema + render call)
- `assets/token-layout.js` v1.1.0 (inner-wrapper custom element)

**Reconciled**: 2026-06-27 (block v1.5.0 / snippet v1.7.0 — color scheme gated by the new `custom_color_scheme` checkbox; `color-scheme:<id>` emitted only when on, else the block rides the surrounding scheme)
