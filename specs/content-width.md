...
**Implementation**:
- `sections/section.liquid` v1.8.1 (`content_width` setting consumer — emits `--content-width: <px/16>rem` per section via dynamic style)
...
**Consumers**:
- `sections/section.liquid` v1.8.1 — `content_width` setting (metaobject picker) drives the section's center grid track cap
