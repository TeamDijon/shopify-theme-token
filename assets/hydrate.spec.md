...
- `base-component.spec.md` — discusses opt-in deferred hydration as an Out of scope item; cross-references this utility as the planned implementation
...
- `modifiers-manager.spec.md` — sibling substrate utility-js spec (calibration reference for spec shape)
- `utility--color-contrast.spec.md` — sibling substrate utility-snippet spec (calibration reference for a small single-function utility)
