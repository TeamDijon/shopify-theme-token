...
//
// Fixture in templates/index.validation--preset--columns-features.json. Media
// uses the placeholder svg (no seeded image needed).

const PATH = '/?view=validation--preset--columns-features';
...
test.describe('validation--preset--columns-features', () => {
