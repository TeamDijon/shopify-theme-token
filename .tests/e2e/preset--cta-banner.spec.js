...
// stacked permanently).
//
// Fixture in templates/index.validation--preset--cta-banner.json. No seeded
// assets (separators + buttons + a placeholder-free group).

const PATH = '/?view=validation--preset--cta-banner';
...
test.describe('validation--preset--cta-banner', () => {
