...
- `richtext.spec.md` — L1 block that handles long-form rich-text body content; consumers may compose `<blockquote>` inline via richtext editorial rather than reaching for this snippet when the quote is one paragraph among many in flowing prose
