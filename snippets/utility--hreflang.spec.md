...
- `layout.spec.md` — head spine stage 7 consumer
- `utility--language.spec.md` — sibling utility emitting the `<html lang>` + `dir` attributes from the same `localization.language` object
