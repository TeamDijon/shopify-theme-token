...
- `utility--asset-loader.spec.md` — primary consumer; routes inline-from-file paths through this wrapper
- `utility--core-assets.spec.md` — uses this wrapper to capture the four core CSS layers
- `icon.spec.md` — uses this wrapper to capture `icon-*.svg` files
