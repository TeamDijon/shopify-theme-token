...
- Button spec (consumer; icon at start / end via `icon_position`): `button.spec.md`
- Title spec (consumer; leading icon at fixed sizing): `title.spec.md`
- Star-rating spec (planned consumer; uses `preset` arg to cycle full/half/empty): `star-rating.spec.md`
