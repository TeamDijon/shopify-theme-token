...
- `utility--hreflang.spec.md` — sibling locale-aware emitter; produces `<link rel="alternate" hreflang>` from the same `localization` object
- `layout.spec.md` — `<html>` attribute consumer
