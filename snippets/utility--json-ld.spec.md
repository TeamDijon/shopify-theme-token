...
- `utility--structured-data.spec.md` — primary consumer; wraps 4 schemas through this utility
- `utility--css-minifier.spec.md` — sibling captured-content emitter; the divergent rules (content-safe vs aggressive token collapse) drive the split between the two
